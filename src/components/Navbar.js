...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {/* <nav className={`nvgtn-m ${tmenu ? 'tmenu' : ''}`}>
        <div className='d-flex justify-content-between'>
          <div className={`logo-c ${tmenu ? 'd-none' : ''}`}>
            <svg className="logo" xmlns="http://www.w3.org/2000/svg" width="87" height="40" viewBox="0 0 87 40" fill="none">
              <rect x="10" y="3.05176e-05" width="20" height="40" fill={logoc.color1} />
              <rect y="3.05176e-05" width="40" height="10" fill={logoc.color2} />
              <path d="M87 0H44L65.5 40L87 0Z" fill={logoc.color3} />
          ...
          <div className={`nvc-m ${tmenu ? '' : 'nvc-e'}`}>
            <div className={`${tmenu ? 'd-none' : ''}`}>Aboutme</div>
            <div className='menu-icon'>
              <input type="checkbox" id="menu" onChange={() => setTmenu(!tmenu)}></input>
      ...
      <nav className="navbar nvgtn-m">
          ...
          <div className="collapse" id="navbarToggleExternalContent">
            <div className={`nvc`}>
              <div className={`nvc-item ${breadcrumb === 'Aboutme'?'bc-active':''}`} onClick={()=>{
                ref.current.click()
                setBreadcrumb('Aboutme')
              }} >
                <div>Aboutme</div>
              </div>
              <div className={`nvc-item ${breadcrumb === 'Projects'?'bc-active':''}`} onClick={()=>{
                ref.current.click()
                setBreadcrumb('Projects')
              }}>
                <div>Projects</div>
              </div>
              <div className={`nvc-item ${breadcrumb === 'Timeline'?'bc-active':''}`} onClick={()=>{
                ref.current.click()
